# Query11 - Análise Completa de Vulnerabilidades do httpd

## Descrição

A **Query11** é um script Python que combina as funcionalidades das queries 7 e 10 para realizar uma análise abrangente das vulnerabilidades do projeto **httpd**, integrando dados de documentação com informações detalhadas dos commits do GitHub.
